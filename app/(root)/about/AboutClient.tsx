        ...
        <div className=" space-y-32">
          ...
          <section className="grid md:grid-cols-5 gap-16 items-start justify-end">
            ...
            <AnimatedContent delay={300}>
              ...
              Our process is deliberate. We design to convey the richness of the narrative you envision for your brand, making your work matter to us as much as it matters to you. When you entrust us with your work, you can be confident that your vision will be realized in an impactful way.
              </p>
              </AnimatedContent>
            </div>
          </section>
